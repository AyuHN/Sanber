describe ('TC 1 -> Check login page', () => {
    it('should be succes show login page correctly', () => {
        ...
        cy.get("input[placeholder='Username']").should('exist').and('be.visible').and('have.value', '');
...
describe ('TC 3 -> Login with valid User Name & Password', () => {
...
describe ('TC 5 -> Click textlink forgot your password', () => {
